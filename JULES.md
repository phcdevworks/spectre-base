...
2. No edits to build artifacts by hand.
3. Commit and push only when validation checks pass clean.
4. If a gate fails and cannot be safely resolved within scope — revert and report the blocker instead of committing a broken state.
