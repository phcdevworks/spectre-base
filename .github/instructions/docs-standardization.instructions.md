...
- Refer to the repository and package as `spectre-base`, and the deployable theme directory as `spectre-theme/`.
...
- When documenting validation, use the real release gate: `build`, `check:assets`, `check:version-sync`, `lint`, `lint:php`, `check:drift`, and `check:ecosystem`.
