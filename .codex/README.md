...
note support, and config standardization.

## Files

- `release-checklist.md` - Codex release gate steps.
- `handoff-template.md` - standard production handoff summary format.

## Related Root Files

- `CODEX.md` - Codex operating guide.
- `AGENTS.md` - shared AI coordination guide.
